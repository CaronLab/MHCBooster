...
pin_files = Path('/mnt/e/data/PXD058436/Search_all_I_0924').rglob('*.pin')
mzml_folder = Path('/mnt/e/data/PXD058436/HLA-I')
output_folder = Path('/mnt/e/data/PXD058436/mhcvalidator')
